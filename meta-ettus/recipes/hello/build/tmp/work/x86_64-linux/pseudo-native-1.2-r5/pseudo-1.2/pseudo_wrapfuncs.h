...
static int wrap_fsetxattr(int filedes, const char *name, const void *value, size_t size, int flags);
static int (*real_fsetxattr)(int filedes, const char *name, const void *value, size_t size, int flags);
...
static ssize_t wrap_getxattr(const char *pathname, const char *name, void *value, size_t size);
static ssize_t (*real_getxattr)(const char *pathname, const char *name, void *value, size_t size);
...
static ssize_t wrap_lgetxattr(const char *pathname, const char *name, void *value, size_t size);
static ssize_t (*real_lgetxattr)(const char *pathname, const char *name, void *value, size_t size);

/* int link(const char *oldpath, const char *newpath) */
static int wrap_link(const char *oldpath, const char *newpath);
static int (*real_link)(const char *oldpath, const char *newpath);

/* ssize_t listxattr(const char *pathname, char *list, size_t size) */
static ssize_t wrap_listxattr(const char *pathname, char *list, size_t size);
static ssize_t (*real_listxattr)(const char *pathname, char *list, size_t size);

/* ssize_t llistxattr(const char *pathname, char *list, size_t size) */
static ssize_t wrap_llistxattr(const char *pathname, char *list, size_t size);
static ssize_t (*real_llistxattr)(const char *pathname, char *list, size_t size);

/* int lremovexattr(const char *pathname, const char *name) */
static int wrap_lremovexattr(const char *pathname, const char *name);
static int (*real_lremovexattr)(const char *pathname, const char *name);

/* int lsetxattr(const char *pathname, const char *name, const void *value, size_t size, int flags) */
static int wrap_lsetxattr(const char *pathname, const char *name, const void *value, size_t size, int flags);
static int (*real_lsetxattr)(const char *pathname, const char *name, const void *value, size_t size, int flags);
...
static int wrap_removexattr(const char *pathname, const char *name);
static int (*real_removexattr)(const char *pathname, const char *name);
...
static int wrap_setxattr(const char *pathname, const char *name, const void *value, size_t size, int flags);
static int (*real_setxattr)(const char *pathname, const char *name, const void *value, size_t size, int flags);
